...
- [`namespaces/default/platform/workflows/docker-with-gitops.yaml`](../namespaces/default/platform/workflows/docker-with-gitops.yaml)
...
> [!IMPORTANT]
> Replace `<your-github-username>` with your GitHub username in each `WorkflowRun` manifest below before applying.
    ...
    parameters:
      ...
      repository:
        ...
        revision:
          branch: main
          commit: ""
        url: https://github.com/<your-github-username>/sample-workloads.git
